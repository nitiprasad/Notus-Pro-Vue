    ...
    <div class="footer-container01">
      ...
      <div class="footer-container08">
        ...
        <div class="footer-container10">
          <span class="footer-text06 textXS">OTHER RESOURCES</span>
          <span class="footer-text07 textSM">License</span>
          <span class="footer-text08 textSM">Terms &amp; Conditions</span>
          <span class="footer-text09 textSM">Privacy Policy</span>
          <span class="footer-text10 textSM">Contact Us</span>
        </div>
      </div>
    </div>
    <div class="footer-container11"></div>
    <span class="footer-text11 textSM">
      Copyright Â© 2021 International Center for Agroecology
    </span>
  </div>
</template>
