<template>
  <div class="header-header" v-bind:class="rootClassName">
    <div class="header-container">
      ...
      <router-link to="/about-us" class="header-navlink1">
        <div class="header-container1">
          ...
          <span class="header-text textSM">About Us</span>
        </div>
      </router-link>
      <router-link to="/research-publications" class="header-navlink2">
        <div class="header-container2">
          ...
          <span class="header-text1 textSM">Research &amp; Publications</span>
        </div>
      </router-link>
    </div>
